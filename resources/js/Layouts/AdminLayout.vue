  ...
  <div class="app-layout">
    ...
    <aside class="sidebar">
      <nav class="sidebar-nav">
        ...
        <ul class="nav-menu">
          <li class="nav-item">
            <Link :href="route('admin.dashboard')" class="nav-link" :class="{ active: $page.component === 'Admin/Dashboard' }">
              TELA INICIAL
            </Link>
          </li>
          <li class="nav-item">
            <Link :href="route('admin.gerenciar')" class="nav-link" :class="{ active: $page.component === 'Admin/Gerenciar' }">
              GERENCIAR ATENDIMENTO
            </Link>
          </li>
          <li class="nav-item">
            <Link :href="route('admin.cadastrar')" class="nav-link" :class="{ active: $page.component === 'Admin/Cadastrar' }">
              CADASTRAR HORÁRIOS DISPONÍVEIS
            </Link>
          </li>
          <li class="nav-item">
            <Link :href="route('admin.perfil')" class="nav-link" :class="{ active: $page.component === 'Admin/Perfil' }">
              PERFIL
            </Link>
          </li>
        </ul>
